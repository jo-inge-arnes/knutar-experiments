...
process_result_group <- function(generator_and_size_index) {
  ...
  # Save plots
  fig_file_name <- paste(curve_name, "_", m, "_", n, "_%s_seed_", seed, "_", experiment_finished_time, ".png", sep = "")
  fig_file_name <- gsub("[ :-]", "_", fig_file_name)
  fig_file_name <- tolower(fig_file_name)
  
  ggsave(sprintf(fig_file_name, "bic_diff_cats"), plot = fig, device = "png", dpi = "print")
  ggsave(sprintf(fig_file_name, "bic_vs_mse1_diffs"), plot = figs$sample, device = "png", dpi = "print")
  ggsave(sprintf(fig_file_name, "bic_vs_mse2_diffs"), plot = figs$uniform_x, device = "png", dpi = "print")
}
