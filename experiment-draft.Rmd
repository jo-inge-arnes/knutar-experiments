...
df_sample_stats <- df_all_results %>%
  ...
  summarise_at(vars(bic_diff, bic_a0, bic_a1, mse_diff, mse_a0, mse_a1, mse_diff_uniform_x, mse_a0_uniform_x, mse_a1_uniform_x, nknots_diff, n), list(mean = mean, median = median, sd = sd))
