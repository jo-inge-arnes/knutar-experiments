...
plot_bic_difference_categories <- function(d, mean_ci, curve_name, m, n) {
  ...
  fig <- ggplot(d, aes(x = bic_diff_cats)) + 
    ...
    xlab(parse_format()("'Differences' <= abs(1)~'are considered equally good.'")) + 
    ylab("Count")  
...
plot_bic_mse_correlations <- function(d, curve_name, m, n) {
  ...
  title <- paste("'", curve_name, " Curve Relationship Between BIC and'~MSE[1]~'Differences (r = ", round(pearson_r, 2), ")'", sep = "")
  ...
  title <- paste("'", curve_name, " Curve Relationship Between BIC and'~MSE[2]~'Differences (r = ", round(pearson_r, 2), ")'", sep = "")
...
process_result_group <- function(generator_and_size_index) {
  ...
  ggsave(gsub("[, ]", "", toString(sprintf(fig_file_name, "bic"))), plot = fig, device = "png", dpi = "print")
  ggsave(gsub("[, ]", "", toString(sprintf(fig_file_name, "mse1"))), plot = figs$sample, device = "png", dpi = "print")
  ggsave(gsub("[, ]", "", toString(sprintf(fig_file_name, "mse2"))), plot = figs$uniform_x, device = "png", dpi = "print")
}
