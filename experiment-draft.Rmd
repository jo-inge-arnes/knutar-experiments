...
generate_x_div_x_plus_half <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_x_div_half_plus_x, f_noise_1)
  return(d)
}

generate_cos <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_cos, f_noise_1)
  return(d)
}
...
generate_mm <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_michaelis_menten, f_noise_1)
  return(d)
}
...
generate_para <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_parabola, f_noise_1)
}
...
generate_logis <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_logistic, f_noise_1)
}
...
generate_gompertz <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_gompertz, f_noise_1)
}
...
generate_logarithmic <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_logarithmic, f_noise_1)
}
...
generate_runge <- function(n) {
  d <- generate_data(n, 3, 3, f_x_dist, f_signal_runge, f_noise_1)
}
...
```{r}
saveRDS(df_all_results, file="experiment-results-12.Rda")
```
